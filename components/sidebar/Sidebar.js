...
const Sidebar = () => {
  return (
    <div className="sidebar h-screen flex flex-col w-[18%] shadow-custom">
        {/* pink border */}
        {/* <div className='h-6 bg-[#FFD1DC] justify-center items-center mb-4'> </div> */}

        {/* sections */}
        <div className="sidebarsections px-6 mt-12 mx-4 flex flex-col h-full justify-between">
            {/* about */}
            {/* <p className='font-bold font-3xl font-times mb-2'>ABOUT</p> */}
            <div>
              <p className='font-normal font-xs font-times mb-4 italic'>
                Hi! I'm <span className='text-[#fc6a8c]'>Riya</span>. Welcome to my little space on the internet where I showcase some of my talents and works. Feel free to stay! 
              </p>
              {/* get in touch */}
